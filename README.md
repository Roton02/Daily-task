...
| Time                    | Task                                                                 |        
| ----------------------- | -------------------------------------------------------------------- |
| **7:00 AM – 12:00 AM**  | 🟢 Block 1: C++ → DSA → LeetCode / Problem Solving                   | 
| **12:00 AM – 2:00 PM**  | 🟢 Block 2: Backend Engineering (Architecture + Projects)            |
| **2:00 PM – 3:00 PM**   | 🍛 Lunch + Shower + Rest                                             |
| **3:00 PM – 6:00 PM**   | 🟢 Block 2 (Continue): Backend Engineering (Architecture + Projects) |
| **6:00 PM – 9:00 PM**   | 🟢 Block 3: DevOps + Networking + System Design                      |
| **9:00 PM – 9:30 PM**   | 🍽️ Dinner + Break                                                   |
| **9:30 PM – 10:30 PM**   | 🟢 Block 4: English                                                  |
| **10:30 PM – 11:30 PM**  | 🟢 Block 5: Remote Job Search + Applications                         |
| **11:30 PM – 12:00 PM** | 📖 Review + Notes + GitHub Commit + Tomorrow's Planning              |
| **12:00 PM**            | 😴 Sleep                                                             |
...
# MONTH 4 — Distributed Engineering
...
প্রতি সপ্তাহে যেন এই ৫টা জিনিস থাকে:

✅ ৮–১২টি LeetCode Problem
...
✅ ১২–১৮টা quality application

---

# আমি একটা জিনিস আরও যোগ করব (যেটা অনেকেই করে না)

তোমার long-term goal AI Infrastructure।

তাই **Month 5**-এর শেষ ২ সপ্তাহে আমি এই topics introduce করতাম (deep না, শুধু foundation):

* Python basics (backend developer হিসেবে দ্রুত শেখার মতো)
* FastAPI overview
* GPU কীভাবে কাজ করে (high level)
